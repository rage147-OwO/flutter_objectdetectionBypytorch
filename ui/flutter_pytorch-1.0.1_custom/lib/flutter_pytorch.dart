...
class FlutterPytorch {
  ...
  static Future<ModelObjectDetection> loadObjectDetectionModel(
      String path, int numberOfClasses, int imageWidth, int imageHeight, List<String> classes) async {
    int index = await ModelApi()
        .loadModel(path, numberOfClasses, imageWidth, imageHeight);
    return ModelObjectDetection(index, imageWidth, imageHeight, classes);
  }
